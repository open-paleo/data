        ...
        steps: [
            ...
            },
            {
                ...
                fields: [
                    ...
                    { header: "Weight max (kg)", type: "text", placeholder: "e.g., 8400", validate: "positiveNumber" },
                    { header: "Hip height min (m)", type: "text", placeholder: "e.g., 3.5", validate: "positiveNumber" },
                    { header: "Hip height max (m)", type: "text", placeholder: "e.g., 4.0", validate: "positiveNumber" },
                    { header: "Holotype specimen ID", type: "text", placeholder: "e.g., CM 9380 (comma-separate multiple for syntypes)", validate: "specimenIds" },
                    { header: "Holotype type", type: "select", optionsKey: "specimen_types", placeholder: "Defaults to holotype" },
        ...
        steps: [
            ...
            },
            {
                ...
                fields: [
                    ...
                    { header: "Weight max (kg)", type: "text", currentKey: "species.size.weight_kg.max", validate: "positiveNumber" },
                    { header: "Hip height min (m)", type: "text", currentKey: "species.size.hip_height_m.min", validate: "positiveNumber" },
                    { header: "Hip height max (m)", type: "text", currentKey: "species.size.hip_height_m.max", validate: "positiveNumber" },
