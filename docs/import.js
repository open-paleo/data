...
window.DataImport = (function ()
{
    ...
    const museumNames = window.OpenPaleo.getSchemaValues("institutions") ?? {};
    ...
    async function fetchPbdbHolotype(name)
    {
        ...
        if (record.museum)
        {
            ...
            result.institution = abbreviation;
        }
    ...
    /**
     * Resolves a museum abbreviation from a specimen ID prefix and
     * returns the canonical institution registry key.
     *
     * @param specimenId - The specimen catalogue number.
     * @returns The institution registry key, or undefined if not recognized.
     */
    function resolveMuseumAbbreviation(specimenId)
    {
        ...
        return museumNames[withHyphen] ? withHyphen : undefined;
    }
