...
| Ruehleia | `galton2001` | R | Wrong-paper-content: the `galton2001.md` markdown is a 1985 *Plateosaurus* cranial-anatomy paper; *Ruehleia bedheimensis* is entirely absent. (The YAML reference was corrected to the Salas proceedings chapter, but the corpus file under this key still needs replacing.) |
