...
| Pawpawsaurus | `lee1996` | P | Markdown is still 28 lines of Taylor & Francis publisher boilerplate after the recent corpus update — the body of the 14-page paper (Journal of Vertebrate Paleontology 16(2):232–245) was not captured. Re-fetch needed. |
...
| Spinops | `farke2011` | S | Markdown is still 12 lines (abstract + author affiliations) after the recent corpus update — body of the 12-page paper (Acta Palaeontologica Polonica 56(4):691–702) was not captured. Re-fetch needed. |
